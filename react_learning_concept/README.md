...
**Why to Learn React**
 ...
 -- job trend and build UI

**When should i learn Rwact**
 -- after mastering JS
 -- most project don't need react in initial phase

**why react was created**
 -- facebook had an issue of *phantom message problem* in which notification count was not updated in facebook
 -- No consistency UI

**React learning Process**
 --go in depth - diffing algo ,  babel , virtual DOM  , hydration , fibre
 -- by making projects 


 **React Fiber - Internal Working**
